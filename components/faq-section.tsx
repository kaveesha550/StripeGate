...
const faqs: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "No, there are no monthly fees. You pay a one-time setup fee ($89.99 for personal, $179.99 for business), and then only Stripe's standard transaction fees apply (typically 2.9% + $0.30 per successful charge).",
  },
]
